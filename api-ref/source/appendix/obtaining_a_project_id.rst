...
-  :ref:`Obtain the Project ID from the Console <en-us_topic_0126416752__en-us_topic_0121673684_section11508201712212>`
...
The API used to obtain a project ID is GET https://{Endpoint}/v3/projects. {Endpoint} is the IAM endpoint and can be obtained from `Regions and Endpoints <https://docs.sc.otc.t-systems.com/en-us/endpoint/index.html>`__. For details about API authentication, see :ref:`Authentication <en-us_topic_0173938834>`.
...
.. _en-us_topic_0126416752__en-us_topic_0121673684_section11508201712212:
